...
```{r, fig.width=12, fig.height=12}
markers.clean.MAST_lam.6533_02_top5 <- read.csv(file = file.path(data.folder,paste0( "DE_cluster_AllMarkerGenes_MAST_lam.6533_res02_top5.csv")))

DoHeatmap(lam.6533, features = markers.clean.MAST_lam.6533_02_top5$gene) + NoLegend()+scale_fill_viridis_c()
```
